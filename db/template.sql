...
VALUES (1, 1, 2, 1, 1, 0, NULL, 5, 44, 0, 'Pyra', 'bladetemplate'),
  ...
  (14, 1, 1, 1, 9, 1, '6th Royal Legion', 5, 44, 1, 'Dagas', 'bladetemplate'),
  (15, 8, 2, 1, 8, 1, 'Shadow Puppets', 5, 44, 1, 'Azami', 'bladetemplate'),
  (16, 5, 2, 3, 10, 1, 'Dandy Lions', 5, 44, 1, 'Nim', 'bladetemplate'),
  (17, 6, 2, 2, 14, 1, 'Zapmeisters', 5, 44, 1, 'Electra', 'bladetemplate'),
  (18, 3, 2, 1, 12, 1, 'Ardent Lancers', 5, 44, 1, 'Perun', 'bladetemplate'),
  (19, 4, 2, 3, 10, 1, 'Contrarians', 5, 44, 1, 'Adenine', 'bladetemplate'),
  (20, 1, 2, 2, 4, 1, 'Battle Cruisers', 5, 44, 1, 'Newt', 'bladetemplate'),
  ...
  (24, 4, 1, 3, 3, 1, 'Voracious Vanguard', 5, 44, 1, 'Boreas', 'bladetemplate'),
  ...
  (28, 3, 1, 2, 14, 1, 'Bravest of the Brave', 5, 44, 1, 'Godfrey', 'bladetemplate'),
  (29, 4, 2, 1, 9, 1, 'Boss Buster Band', 5, 44, 1, 'Zenobia', 'bladetemplate'),
  (30, 2, 2, 1, 12, 1, 'Gutsy Glaives', 5, 44, 1, 'Praxis', 'bladetemplate'),
  (31, 3, 2, 2, 4, 1, 'Purificators', 5, 44, 1, 'Theory', 'bladetemplate'),
  (32, 2, 2, 1, 8, 1, 'Royal Teas', 5, 44, 1, 'Sheba', 'bladetemplate'),
  (33, 5, 2, 1, 9, 1, 'Frontier Falcons', 5, 44, 1, 'Agate', 'bladetemplate'),
  (34, 8, 2, 2, 14, 1, 'Arrowroot Company', 5, 44, 1, 'Kasandra', 'bladetemplate'),
  (35, 3, 2, 3, 3, 1, 'Perennial Beauties', 5, 44, 1, 'Dahlia', 'bladetemplate'),
  (36, 3, 2, 3, 10, 1, 'Ursula\'s New Groove', 5, 44, 1, 'Ursula', 'bladetemplate'),
  (37, 7, 2, 1, 8, 1, 'Erde Kaisers', 5, 44, 1, 'KOS-MOS', 'bladetemplate');
/*!40000 ALTER TABLE `blade_superclass`
  ENABLE KEYS */;
UNLOCK TABLES;
